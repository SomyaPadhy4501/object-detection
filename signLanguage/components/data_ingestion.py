...
class DataIngestion:
    ...
    def inititate_data_ingestion(self)-> DataIngestionArtifact:
        logging.info("Entrered initiate_data_ingestion method of Data_Ingestion class")
        try:
            ...
            logging.info("Exited initiate_data_ingestion method method of Data_Ingestion class")
